...
#define STRING_CONFIG_H_AUTHOR "(Daniel, SKR mini E3 Anet A8)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "The Beast is"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 413.95 }
